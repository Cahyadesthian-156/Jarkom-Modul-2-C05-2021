...
**Pada EniesLobby** 
Masuk ke directory ```vi /etc/bind/kaizoku/franky.C05.com``` kemudian uncomment bagian
``` 
...
Lakukan juga edit pada  /etc/bind/kaizoku/super.franky.C05.com
```
echo -e’;
$TTL 	604800
...
## 7. Untuk memperlancar komunikasi Luffy dan rekannya, dibuatkan subdomain melalui Water7 dengan nama general.mecha.franky.yyy.com dengan alias www.general.mecha.franky.yyy.com yang mengarah ke Skypie(7). 
...
Lakukan perintah ```lynx super.franky.C05.com/(kalimat apa saja yang salah) ``` untuk melihat hasil errornya
...
```
Setelah itu, edit file general-script.sh untuk directory /etc/apache2/sites-available/general.mecha.franky.C05.com.conf
```
...
Kemudian restrart dengan perintah 
...
Masukkan username dan password yang sudah dibuat dan akan menampilkan gambar berikut:
[#]
...
**Pada Loguetown dan Alabasta**
Jalankan perintah `lynx 192.186.2.4` dan akan menampilkan gambar sebagai berikut:
[#]
